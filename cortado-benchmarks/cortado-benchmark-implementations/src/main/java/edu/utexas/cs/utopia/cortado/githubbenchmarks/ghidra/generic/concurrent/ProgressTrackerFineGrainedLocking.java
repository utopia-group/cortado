 ...
 */
class ProgressTrackerFineGrainedLocking implements ProgressTrackerInterface
{
    private final ReentrantLock inProgressLock = new ReentrantLock();

    // private AtomicLong inProgressCount = new AtomicLong();
	private long inProgressCount = 0;

    private final ReentrantLock nextIDLock = new ReentrantLock();
	...
	ProgressTrackerFineGrainedLocking()
    {
