...
public class ImplicitRoundTripWorkerExpresso implements RoundTripWorkerInterface
{
    public ImplicitRoundTripWorkerExpresso(@SuppressWarnings("unused") int maxMessages)
    {
